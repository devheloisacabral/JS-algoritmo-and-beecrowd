...
// o automóvel faz 12 km para cada litro de gasolina
// pedir o tempo gasto na viagem e pedir a velocidade media para poder calcular o delta s(distancia)


function GastoDeGasolina(tempo, velocidade){
    const distancia = velocidade * tempo
    const gasto = (distancia / 12).toFixed(3)
    console.log('Para esse deslocamento, o gasto de combustivel sera de ' + gasto +' litros')
}

GastoDeGasolina(10,85)